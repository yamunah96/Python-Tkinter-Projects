...
# Scoreboard
score_label = tk.Label(root, text="You: 0  |  AI: 0", font=("Arial", 16), fg="black", bg="white")
...
user_roll_label = tk.Label(result_frame, text="Your Roll: -", font=("Arial", 14), bg="white")
...
def roll_dice():
    ...
    user_roll_label.config(text=f"Your Roll: {user_roll}")
    ai_roll_label.config(text=f"AI Roll: {ai_roll}")
