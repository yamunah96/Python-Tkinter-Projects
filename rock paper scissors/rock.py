...
# Last choices
choice_frame = tk.Frame(root, bg="red")
choice_frame.pack(pady=10)

human_choice_label = tk.Label(choice_frame, text="", font=("Helvetica", 12), bg="white")
...
ai_choice_label = tk.Label(choice_frame, text="", font=("Helvetica", 12), bg="white")
